        ...
        <ul class="space-y-4">
            ...
            <li>
                <a href="/admin"
                   ...
                   {{ request()->is('admin') ? 'bg-white/20 font-semibold' : 'hover:bg-white/10' }}">
                    Dashboard
                </a>
            </li>
            ...
            <li>
                <a href="/admin/dokter"
                   class="block px-4 py-2 rounded-lg
                   {{ request()->is('admin/dokter') ? 'bg-white/20 font-semibold' : 'hover:bg-white/10' }}">
                    Data Dokter
                </a>
            </li>
            ...
            <li>
                <a href="/admin/pasien"
                   class="block px-4 py-2 rounded-lg
                   {{ request()->is('admin/pasien') ? 'bg-white/20 font-semibold' : 'hover:bg-white/10' }}">
                    Data Pasien
                </a>
            </li>
            ...
            <li>
                <a href="/admin/jadwal"
                   class="block px-4 py-2 rounded-lg
                   {{ request()->is('admin/jadwal') ? 'bg-white/20 font-semibold' : 'hover:bg-white/10' }}">
                    Jadwal Dokter
                </a>
            </li>
            ...
            <li>
                <a href="/admin/obat"
                   class="block px-4 py-2 rounded-lg
                   {{ request()->is('admin/obat') ? 'bg-white/20 font-semibold' : 'hover:bg-white/10' }}">
                    Data Obat
                </a>
            </li>
