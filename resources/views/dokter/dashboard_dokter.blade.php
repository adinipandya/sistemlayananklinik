...
<div class="grid lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-3xl p-6 shadow-sm">
        <div class="flex justify-between items-start">
            <div>
                <p class="text-slate-500 text-sm">Pasien Hari Ini</p>
                <h2 class="text-4xl font-bold mt-2 text-slate-800">{{ $pasienHariIni }}</h2>
            </div>
...
<div class="grid lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 bg-white rounded-3xl shadow-sm">
        <div class="p-6 border-b">
            <h2 class="font-bold text-lg">Jadwal Konsultasi Hari Ini</h2>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full">
                <thead>
                    <tr class="text-slate-500 text-sm">
                        <th class="text-left p-5">Jam</th>
                        <th class="text-left p-5">Pasien</th>
                        <th class="text-left p-5">Keluhan</th>
    ...
    <div class="bg-white rounded-3xl shadow-sm p-6">
        <div class="text-center">
            ...
            <h3 class="font-bold text-xl mt-4">{{ Auth::user()->name }}</h3>
            <p class="text-slate-500">Dokter Umum</p>
        </div>

        <div class="mt-8 space-y-4">
            <div class="flex justify-between">
                <span class="text-slate-500">SIP</span>
                <span>SIP-2026-001</span>
            </div>
            <div class="flex justify-between">
...
<div class="grid md:grid-cols-3 gap-6 mt-8">
    ...
    <a href="/dokter/konsultasi" class="bg-gradient-to-r from-blue-600 to-cyan-500 text-white p-6 rounded-3xl">
        <h3 class="font-bold text-lg">Konsultasi Pasien</h3>
        <p class="mt-2 opacity-90">Mulai pemeriksaan pasien</p>
    </a>

    <a href="/dokter/jadwal" class="bg-gradient-to-r from-blue-600 to-green-500 text-white p-6 rounded-3xl">
        <h3 class="font-bold text-lg">Jadwal Praktik</h3>
        <p class="mt-2 opacity-90">Kelola jadwal konsultasi</p>
    </a>

    <a href="/dokter/kelola" class="bg-gradient-to-r from-blue-600 to-cyan-500 text-white p-6 rounded-3xl">
        <h3 class="font-bold text-lg">Rekam Medis</h3>
        <p class="mt-2 opacity-90">Lihat riwayat pasien</p>
    </a>
