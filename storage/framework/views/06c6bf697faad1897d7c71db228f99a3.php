...
<!-- SIDEBAR -->
<aside id="sidebar"
    class="fixed top-16 left-0 bottom-0
    ...
    <div class="h-full flex flex-col p-5">
        ...
        <nav class="space-y-2">
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-lg
            <?php echo e(request()->is('pasien/booking')
                ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-600 font-semibold'
                : 'text-slate-700 hover:bg-slate-100'); ?>">
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-lg
            <?php echo e(request()->is('pasien/jadwal')
                ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-600 font-semibold'
                : 'text-slate-700 hover:bg-slate-100'); ?>">
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-lg
            <?php echo e(request()->is('pasien/rekam-medis')
                ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-600 font-semibold'
                : 'text-slate-700 hover:bg-slate-100'); ?>">
            ...
            class="flex items-center gap-3 px-4 py-3 rounded-lg
            <?php echo e(request()->is('pasien/feedback')
                ? 'bg-blue-50 text-blue-600 border-l-4 border-blue-600 font-semibold'
                : 'text-slate-700 hover:bg-slate-100'); ?>">
...
<?php /**PATH /Users/ardiansyah/laravel/sistemlayananklinik/resources/views/layouts/pasien.blade.php ENDPATH**/ ?>