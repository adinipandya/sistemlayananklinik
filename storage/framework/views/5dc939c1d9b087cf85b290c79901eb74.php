        ...
        <div class="mb-14 reveal" data-aos="fade-up">
            <div class="max-w-6xl mx-auto px-5">
                ...
                <div class="grid md:grid-cols-3 gap-6">
                    ...
                    <div class="relative reveal" style="transition-delay: <?php echo e($i * 80); ?>ms">
                        ...
                        <div class="bg-mist rounded-2xl p-7">
                            <div class="flex items-center gap-3 mb-5">
                                ...
                                <span class="text-[11px] font-extrabold tracking-widest text-ink uppercase">Langkah <?php echo e($step['n']); ?></span>
                            </div>
                            <h3 class="font-extrabold text-ink text-lg mb-2"><?php echo e($step['judul']); ?></h3>
                            <p class="text-sm text-slate leading-relaxed"><?php echo e($step['desc']); ?></p>
                        </div>
                    </div>
        ...
        <div class="mb-12 reveal" data-aos="fade-up">
            <div class="max-w-6xl mx-auto px-5">
                ...
                <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-5">
                    <?php $__currentLoopData = $layanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white rounded-2xl p-6 card-hover border border-gray-100 reveal"
                        style="transition-delay: <?php echo e(($i % 3) * 60); ?>ms">
                        <div class="w-11 h-11 <?php echo e($item['bg']); ?> rounded-xl flex items-center justify-center mb-5">
                            <svg class="w-5 h-5 <?php echo e($item['fg']); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="<?php echo e($item['icon']); ?>" />
                            </svg>
                        </div>
                        <h3 class="font-extrabold text-ink mb-2"><?php echo e($item['judul']); ?></h3>
                        <p class="text-sm text-slate leading-relaxed"><?php echo e($item['desc']); ?></p>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <div class="bg-white rounded-2xl p-6 card-hover border border-gray-100 reveal"
            ...
            <div class="max-w-6xl mx-auto px-5">
                ...
                <div class="grid md:grid-cols-3 gap-5">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $feedback; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-white rounded-2xl p-6 card-hover border border-gray-100 reveal"
                        style="transition-delay: <?php echo e(($loop->index % 3) * 70); ?>ms">

                        
                        <div class="flex gap-0.5 mb-4">
                            <?php for($s = 1; $s <= 5; $s++): ?>
                                <svg class="w-4 h-4 <?php echo e($s <= ($item->rating ?? 5) ? 'text-amber' : 'text-gray-200'); ?>"
                        ...
                        <p class="text-sm text-gray-700 leading-relaxed mb-5">
                            "<?php echo e(\Illuminate\Support\Str::limit($item->komentar, 130)); ?>"
                        </p>
                        ...
                        <div class="flex items-center gap-3 pt-4 border-t border-gray-100">
                            <div class="w-8 h-8 rounded-full bg-ink flex items-center justify-center
                                ...
                                <?php echo e(strtoupper(substr($item->user->name ?? 'P', 0, 1))); ?>

                            </div>
                            <div>
                                <p class="text-sm font-semibold text-ink"><?php echo e($item->user->name ?? 'Pasien'); ?></p>
                                <p class="text-xs text-slate"><?php echo e($item->created_at->format('d M Y')); ?></p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="space-y-3 reveal">
                ...
                <div class="bg-white rounded-2xl border border-gray-200 overflow-hidden">
                    <button onclick="toggleFaq(<?php echo e($i); ?>)"
                        ...
                        <span class="text-sm font-semibold text-ink pr-4"><?php echo e($faq['q']); ?></span>
                        <svg id="faq-icon-<?php echo e($i); ?>"
                            class="w-4 h-4 text-slate flex-shrink-0 transition-all duration-500 ease-out"
                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <div id="faq-body-<?php echo e($i); ?>" class="faq-body px-6">
                        <p class="text-sm text-slate leading-relaxed pb-5"><?php echo e($faq['a']); ?></p>
                    </div>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
...
</html><?php /**PATH /Users/ardiansyah/laravel/sistemlayananklinik/resources/views/pages/home.blade.php ENDPATH**/ ?>