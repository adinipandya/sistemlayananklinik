...
<form method="GET" action="/dokter/pasien" class="bg-white rounded-2xl shadow-sm border p-5 mb-6">
    ...
    <div class="flex gap-3">
        ...
        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari nama pasien..."
    ...
    <table class="w-full">
        ...
        <tbody>
            ...
            <tr class="border-t">
                ...
                <td class="p-4">
                    RM<?php echo e(str_pad($loop->iteration, 3, '0', STR_PAD_LEFT)); ?>
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <div class="space-y-2 text-slate-600">
                        ...
                        <p><b>No RM :</b> RM001</p>
                        <p><b>Nama :</b> <?php echo e($item->name); ?></p>
...
<?php echo $__env->make('layouts.dokter', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistemlayananklinik\resources\views/dokter/data_pasien.blade.php ENDPATH**/ ?>