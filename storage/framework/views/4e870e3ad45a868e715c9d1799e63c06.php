...
<div class="grid md:grid-cols-4 gap-5 mb-8">
    ...
    <div class="bg-white border border-slate-200 rounded-xl p-5">
        ...
        <h2 class="text-3xl font-bold text-blue-600 mt-2"><?php echo e($totalPasien); ?></h2>
    </div>

    <div class="bg-white border border-slate-200 rounded-xl p-5">
        <p class="text-sm text-slate-500">Pasien Aktif</p>
        <h2 class="text-3xl font-bold text-green-600 mt-2"><?php echo e($pasienAktif); ?></h2>
    </div>

    <div class="bg-white border border-slate-200 rounded-xl p-5">
        <p class="text-sm text-slate-500">Menunggu Verifikasi</p>
        <h2 class="text-3xl font-bold text-yellow-500 mt-2"><?php echo e($menungguVerifikasi); ?></h2>
    </div>

    <div class="bg-white border border-slate-200 rounded-xl p-5">
        <p class="text-sm text-slate-500">Profil Belum Lengkap</p>
        <h2 class="text-3xl font-bold text-red-500 mt-2"><?php echo e($profilBelumLengkap); ?></h2>
    </div>
    ...
    <table class="w-full">
        ...
        <tbody>
            ...
            <tr class="border-t">
                ...
                <td class="p-4"><?php echo e($item->nik); ?></td>
                <td class="p-4"><?php echo e($item->no_hp); ?></td>
